...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/urlpath-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12724&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/urlpath-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `urlpath` can be installed with:

```
conda install urlpath
```

It is possible to list all of the versions of `urlpath` available on your platform with:
